...
@Component({
  selector: 'app-listasignacionmp',
  templateUrl: './listasignacionmp.component.html',
  styleUrls: ['./listasignacionmp.component.scss']
})
export class ListasignacionmpComponent implements OnInit {
  productos:  any;
  ...
  onLoadClasificacionmp() {
    this.servProductos.getClasificacionmp().subscribe(
      data => {
