...
import { PdfmakeService } from '../../../../pdfmake/mdfmake.service';
...
export class ListcertificadosptComponent implements OnInit {
  ...
  obtenerDatosReporte(codigo_certificado: string) {
    this.onLoadCertificado(codigo_certificado);
  }
...
//#endregion
    ...
    doc.text(190, 35, 'FOR813301', null, null, 'center');
    ...
    doc.setFontSize(10);
    doc.setFontStyle('bold');
    doc.text(18, 47, 'Nombre Producto');
    doc.setFontSize(10);
    doc.setFontStyle('bold');
    doc.text(83, 47, 'Concentración');
    doc.setFontSize(10);
    doc.setFontStyle('bold');
    doc.text(148, 47, 'Forma Farmacéutica');
    doc.rect(10, 43, 65, 6);
    doc.rect(75, 43, 65, 6);
    ...
    doc.setFontSize(9);
    doc.setFontStyle('bold');
    doc.text(11, 59, 'Cantidad Fabricada');
    doc.setFontSize(9);
    doc.setFontStyle('normal');
    doc.text(41, 65, c.cantidad_fabricada, null, null, 'right');
    doc.rect(10, 55, 32.5, 6);
    doc.rect(10, 61, 32.5, 6);

    doc.setFontSize(9);
    doc.setFontStyle('bold');
    doc.text(60, 59, 'N° de Lote', null, null, 'center');
    doc.setFontSize(9);
    doc.setFontStyle('normal');
    doc.text(60, 65, c.lote, null, null, 'center');
    doc.rect(42.5, 55, 32.5, 6);
    doc.rect(42.5, 61, 32.5, 6);

    doc.setFontSize(9);
    doc.setFontStyle('bold');
    doc.text(155, 59, 'Fecha de Fab.', null, null, 'center');
    doc.setFontSize(10);
    doc.setFontStyle('normal');
    doc.text(155, 65, c.fecha_fabricacion.substr(0, 10), null, null, 'center');
    doc.rect(140, 55, 32.5, 6);
    doc.rect(140, 61, 32.5, 6);

    doc.setFontSize(10);
    doc.setFontStyle('bold');
    doc.text(190, 59, 'Fecha de Vmto', null, null, 'center');
    doc.setFontSize(10);
    doc.setFontStyle('normal');
    doc.text(190, 65, c.fecha_vencimiento.substr(0, 10), null, null, 'center');
    doc.rect(172.5, 55, 32.5, 6);
    doc.rect(172.5, 61, 32.5, 6);
    ...
    this.lcf.forEach((element, index) => {
      ...
      for (let m = 0; m < count_celda; m++) {
        ...
        doc.text(170, 86.5 + alto1, element['resultado'], null, null, 'center');
    ...
    doc.setFontStyle('bold');
    doc.text(12, 119 + alto1 + alto2 + alto3 , 'PRESENTACIÓN');
    doc.text(12, 119 + alto1 + alto2 + alto3 + 5, c.presentacion);

    doc.rect(10, 131 + alto1 + alto2 + alto3 , 195, 5);
    doc.rect(10, 136 + alto1 + alto2 + alto3 , 195, 10);
    doc.setFontStyle('bold');
    doc.text(12, 135 + alto1 + alto2 + alto3 , 'CONSERVACIÓN Y ALMACENAMIENTO');
    doc.text(12, 135 + alto1 + alto2 + alto3 + 5, c.conservacionyalm);

    doc.rect(10, 147 + alto1 + alto2 + alto3 , 195, 5);
    doc.rect(10, 152 + alto1 + alto2 + alto3 , 195, 10);
    doc.setFontStyle('bold');
    doc.text(12, 151 + alto1 + alto2 + alto3 , 'REFERENCIAS');
    doc.text(12, 151 + alto1 + alto2 + alto3 + 5, c.referencias);

    doc.rect(10, 163 + alto1 + alto2 + alto3 , 195, 5);
    doc.rect(10, 168 + alto1 + alto2 + alto3 , 195, 10);
    doc.setFontStyle('bold');
    doc.text(12, 167 + alto1 + alto2 + alto3 , 'OBSERVACIONES');
    doc.text(12, 167 + alto1 + alto2 + alto3 + 5, c.observaciones);
    ...
    doc.text(150, i + 144, 'Vo Bo DIRECTOR TÉNCNICO');
